            ...
            <div class="col-lg-9 col-md-8 col-sm-12 col-12 mb-50">
                <div class="content-single">
                    ...
                    <div class="dashboard_overview">
                        <div class="row">
                            <div class="col-lg-4 col-md-6">
                                <div class="dash_overview_item bg-info-subtle">
                                    <h2>{{ $jobAppliedCount }} <span>Vacantes aplicadas</span></h2>
                                    <span class="icon"><i class="fas fa-briefcase"></i></span>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                <div class="dash_overview_item bg-danger-subtle">
                                    <h2>{{ $userBookmarksCount }} <span>Marcadores</span></h2>
                        ...
                        @endif
                        <h3 class="mt-30 mb-0 color-brand-1">Ultimas vacantes aplicadas</h3>
