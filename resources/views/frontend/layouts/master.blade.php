...
<body>
  <div class="preloader_demo d-none">
    <div class="img">
      <img src="{{ asset('frontend/assets/imgs/template/loading.gif') }}" alt="tupasantia">
    </div>
  </div>
  ...
  <div id="preloader-active">
    <div class="preloader d-flex align-items-center justify-content-center">
      <div class="preloader-inner position-relative">
        <div class="text-center"><img src="{{ asset('frontend/assets/imgs/template/loading.gif') }}" alt="tupasantia"></div>
      </div>
    </div>
  </div>
