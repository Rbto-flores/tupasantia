<section class="section-box mt-80">
    <div class="container">
        <div class="text-center">
            <h2 class="section-title mb-10 wow animate__animated animate__fadeInUp">Vacantes por departmento</h2>
            <p class="font-lg color-text-paragraph-2 wow animate__animated animate__fadeInUp">Encuentras oportunidades cerca de ti</p>
        </div>
    </div>
    <div class="container">
        <div class="row mt-50">
