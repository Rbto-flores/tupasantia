<section class="section-box recruiters mt-60">
    <div class="container">
        <div class="text-center">
            <h2 class="section-title mb-10 wow animate__animated animate__fadeInUp">Empresas afiliadas</h2>
            <p class="font-lg color-text-paragraph-2 wow animate__animated animate__fadeInUp">Descubre tu proxima oportunidad</p>
        </div>
    </div>
    <div class="container">
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="item-5 hover-up wow animate__animated animate__fadeIn">
                            <a href="{{ route('companies.show', $company->slug) }}">
                                <div class="item-logo">
                                    <div class="image-left"><img alt="tupasantia" src="{{ asset($company->logo) }}">
                                    </div>
