  ...
  <div class="section-box wow animate__animated animate__fadeIn">
    <div class="container">
      <div class="text-center">
        <h2 class="section-title mb-10 wow animate__animated animate__fadeInUp">¿Que opinan nuestros clientes?</h2>
        <p class="font-lg color-text-paragraph-2 wow animate__animated animate__fadeInUp">Cientos de empresas, estudiantes
          y egresados<br class="d-none d-lg-block">han conseguido conectar!</p>
      </div>
